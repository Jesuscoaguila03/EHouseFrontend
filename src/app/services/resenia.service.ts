...
export class ReseniaService {
  ...
  insert(resenia: Resenia): Observable<any> {
    return this.http.post(this.url + "/resenia", resenia);
  }

  update(resenia: Resenia): Observable<any> {
    return this.http.put(this.url + "/resenia", resenia);
  }
