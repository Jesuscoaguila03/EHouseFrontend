...
export class ReservaListarComponent {
  lista: Reserva[] = [];
  displayedColumns = ['idReserva', 'cantidadPersonas', 'fecha_reserva', 'fechaInicio', 'fechaFin','precioTotal', 'estadoReserva', 'habitacion', 'idServiciosAdicionales', 'accion01', 'accion02'];
