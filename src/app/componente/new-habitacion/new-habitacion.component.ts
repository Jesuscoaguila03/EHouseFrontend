...
export class NewHabitacionComponent {
  ...
  cargarForm() {
    if(this.edicion){
      this.habitacionService.listID(this.id).subscribe((data: Habitacion) =>{
        console.log(data);
  ...
  onSubmit() {
    if (this.habitacionForm.valid) {
      ...
      habitacion.idHabitacion = this.id;
      ...
      if (!this.edicion) {
        console.log("Datos ingresados: ", habitacion);
        //suscribe -> asincrono para que no nos bloquee
        this.habitacionService.insert(habitacion).subscribe((data: object): void => {
          console.log("Datos insertados:", data);
        })
      } else {
        console.log("Datos ingresados: ", habitacion);
        //suscribe -> asincrono para que no nos bloquee
        this.habitacionService.update(habitacion).subscribe((data: Object): void => {
